...
# user_search based on the movie name
user_search = input("Enter a movie name: ")

# Filter movies by user's input movie name

filtered_movies = movie_DF[movie_DF['Name of movie'].str.contains(user_search, case=False)]
